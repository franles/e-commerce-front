...
const ModalCart = () => {
    ...
    if (!isModalOpen) return null //solo renderizarse si el modal esta abierto
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="modal-action mt-4 gap-3 flex flex-col lg:flex-row lg:justify-between">
                            ...
                            <Link className='btn btn-info btn-outline' onClick={closeModal} to='/'>Seguir comprando</Link>
                            <Link className='btn btn-primary ' onClick={closeModal} to='/checkout'>Proceder al pago</Link>
                        </div>
                    </>
                )}
            </section>
